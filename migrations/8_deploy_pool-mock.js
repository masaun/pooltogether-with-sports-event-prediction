...
const _oracleManager = OracleManager.address;
...
module.exports = async function(deployer, network, accounts) {
    ...
    await deployer.deploy(PoolMock, _erc20, _cErc20, _prediction, _rewardManager, _oracleManager).then(async function(poolMock) {
